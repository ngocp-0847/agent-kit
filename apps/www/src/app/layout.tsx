  ...
  return (
    <html lang="en" suppressHydrationWarning>
      ...
      >
        ...
        <div className="pointer-events-none absolute left-1/2 top-0 size-[300px] md:size-[400px] lg:size-[600px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-primary/10 blur-[120px]" />
        <ThemeProvider
          attribute="class"
          defaultTheme="dark"
          enableSystem
